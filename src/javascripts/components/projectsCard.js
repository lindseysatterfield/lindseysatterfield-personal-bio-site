...
const createProjectCards = (array) => {
  ...
  for (let i = 0; i < array.length; i += 1) {
    domString += `
    <div class="card m-4 text-center" style="width: 18rem; height: 35em;">
      ...
      <div class="card-body" style="background-color: #564AA5; color: white;">
        ...
        <p class="card-text">${array[i].description}</p>
          ...
          <p class="card-text"><a href="${array[i].url}" target="_blank">Live Site</a></p>
          <p class="card-text"><a href="${array[i].githubUrl}" target="_blank" style="text-decoration: none">Github</a></p>
      </div>
    </div>`;
